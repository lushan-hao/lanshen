...
var locale = require('antd/es/date-picker/locale/zh_CN');
...
var _slicedToArray$1 = require('@babel/runtime/helpers/esm/slicedToArray');
var _objectWithoutProperties$1 = require('@babel/runtime/helpers/esm/objectWithoutProperties');
var _defineProperty$2 = require('@babel/runtime/helpers/esm/defineProperty');
...
var _slicedToArray__default =
  /*#__PURE__*/ _interopDefaultLegacy(_slicedToArray$1);
var _objectWithoutProperties__default = /*#__PURE__*/ _interopDefaultLegacy(
  _objectWithoutProperties$1,
);
var _defineProperty__default =
  /*#__PURE__*/ _interopDefaultLegacy(_defineProperty$2);
      ...
      'span',
      {
        ...
        onClick: function onClick() {
          ...
          _onChange === null || _onChange === void 0
            ? void 0
            : _onChange(
                moment__default['default'](value).add(-1, 'days'),
                moment__default['default'](value)
                  .add(-1, 'days')
                  .format('YYYY-MM-DD'),
              );
        },
...
var DatePickerQuick = function DatePickerQuick(props) {
  ...
  var _useState = React.useState(moment__default['default'](value)),
    _useState2 = _slicedToArray(_useState, 2),
    mergedValue = _useState2[0],
    setInnerValue = _useState2[1];

  var _useState3 = React.useState(moment__default['default'](valueEnd)),
  ...
  React.useEffect(
    function () {
      setInnerValue(moment__default['default'](value));
    },
    [value],
  );
  React.useEffect(
    function () {
      setInnerValueEnd(moment__default['default'](valueEnd));
    },
    [valueEnd],
  );
  var presetChange = React.useCallback(
        ...
        !pageType &&
          /*#__PURE__*/ React__default['default'].createElement(
            antd.Button,
            {
              ...
              onClick: function onClick() {
                presetChange(
                  moment__default['default']().add(-1, 'days').startOf('date'),
                  moment__default['default']().add(-1, 'days').startOf('date'),
                );
              },
            },
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    dateType === 1 &&
      /*#__PURE__*/ React__default['default'].createElement(SingleDatePicker, {
        locale: locale__default['default'],
        value: moment__default['default'](mergedValue),
        format: format,
        allowClear: allowClear,
    ...
    dateType === 2 &&
      /*#__PURE__*/ React__default['default'].createElement(
        ...
        /*#__PURE__*/ React__default['default'].createElement(RangePicker, {
          locale: locale__default['default'],
          value: [
            moment__default['default'](mergedValue),
            moment__default['default'](mergedValueEnd),
          ],
          allowClear: allowClear,
          format: format,
...
var index = /*#__PURE__*/ React.memo(DatePickerQuick);
...
function fillRef(ref, node) {
  if (typeof ref === 'function') {
    ...
    _typeof__default['default'](ref) === 'object' &&
    ref &&
    'current' in ref
  ) {
    ref.current = node;
...
function addEventListenerWrap(target, eventType, cb, option) {
  /* eslint camelcase: 2 */
  var callback = ReactDOM__default['default'].unstable_batchedUpdates
    ? function run(e) {
...
var Portal = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  return containerRef.current
    ? /*#__PURE__*/ ReactDOM__default['default'].createPortal(
        children,
...
function getAlignFromPlacement(builtinPlacements, placementStr, align) {
  ...
  return _objectSpread__default['default'](
    _objectSpread__default['default']({}, baseAlign),
    align,
  );
}
...
function getTransitionName(transitionName, transitionType) {
  ...
  if (_typeof__default['default'](transitionName) === 'object') {
...
var useStepQueue = function (status, callback) {
  ...
  var _useNextFrame = useNextFrame(),
    _useNextFrame2 = _slicedToArray__default['default'](_useNextFrame, 2),
...
function useStatus(supportMotion, visible, getElement, _ref) {
  ...
  var _useDomMotionEvents = useDomMotionEvents(onInternalMotionEnd),
    _useDomMotionEvents2 = _slicedToArray__default['default'](
      _useDomMotionEvents,
      1,
    ),
  ...
  var _useStepQueue = useStepQueue(status, function (newStep) {
    ...
    _useStepQueue2 = _slicedToArray__default['default'](_useStepQueue, 2),
  ...
  if (eventHandlers[STEP_PREPARE] && step === STEP_START) {
    mergedStyle = _objectSpread__default['default'](
      {
        transition: 'none',
      },
      mergedStyle,
...
var DomWrapper = /*#__PURE__*/ (function (_React$Component) {
  _inherits__default['default'](DomWrapper, _React$Component);

  var _super = _createSuper__default['default'](DomWrapper);

  function DomWrapper() {
    _classCallCheck__default['default'](this, DomWrapper);

    return _super.apply(this, arguments);
  }

  _createClass__default['default'](DomWrapper, [
    {
      key: 'render',
...
function genCSSMotion(config) {
  ...
  var CSSMotion = /*#__PURE__*/ React.forwardRef(function (props, ref) {
    ...
    var _useStatus = useStatus(supportMotion, visible, getDomElement, props),
      _useStatus2 = _slicedToArray__default['default'](_useStatus, 4),
    ...
    var mergedProps = _objectSpread__default['default'](
      _objectSpread__default['default']({}, eventProps),
      {},
      {
        visible: visible,
      },
    ...
    if (!children) {
      ...
      if (mergedVisible) {
        motionChildren = children(
          _objectSpread__default['default']({}, mergedProps),
          setNodeRef,
        );
...
function Mask(props) {
  ...
  if (maskMotion || maskTransitionName || maskAnimation) {
    motion = _objectSpread__default['default'](
      {
        motionAppear: true,
      },
      getMotion({
  ...
  return /*#__PURE__*/ React.createElement(
    CSSMotion,
    _extends__default['default']({}, motion, {
      visible: visible,
      removeOnLeave: true,
    }),
    function (_ref) {
...
function getPoint(point) {
  if (_typeof__default['default'](point) !== 'object' || !point) return null;
  return point;
}
...
var Align = function Align(_ref, ref) {
  ...
  var _useBuffer = useBuffer(function () {
    ...
    _useBuffer2 = _slicedToArray__default['default'](_useBuffer, 2),
  ...
  React__default['default'].useEffect(function () {
    ...
    if (
      ...
      !isEqual__default['default'](cacheRef.current.align, align)
    ) {
  ...
  if (/*#__PURE__*/ React__default['default'].isValidElement(childNode)) {
    childNode = /*#__PURE__*/ React__default['default'].cloneElement(
      childNode,
      {
    ...
    function () {
      ...
      if (status) {
        rafRef.current = wrapperRaf(
          /*#__PURE__*/ _asyncToGenerator__default['default'](
...
var PopupInner = /*#__PURE__*/ React.forwardRef(function (props, ref) {
  ...
  var _useStretchStyle = useStretchStyle(stretch),
    _useStretchStyle2 = _slicedToArray__default['default'](_useStretchStyle, 2),
  ...
  var _useVisibleStatus = useVisibleStatus(visible, doMeasure),
    _useVisibleStatus2 = _slicedToArray__default['default'](
      _useVisibleStatus,
      2,
    ),
  ...
  var motion = _objectSpread__default['default']({}, getMotion(props));
  ...
  var mergedStyle = _objectSpread__default['default'](
    _objectSpread__default['default']({}, stretchStyle),
    {},
    {
      zIndex: zIndex,
      opacity:
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    function (_ref, motionRef) {
      ...
      var mergedClassName = classNames__default['default'](
        prefixCls,
        className,
        alignedClassName,
        motionClassName,
        ...
        /*#__PURE__*/ React.createElement(
          'div',
          {
            ...
            style: _objectSpread__default['default'](
              _objectSpread__default['default']({}, motionStyle),
              mergedStyle,
            ),
          },
          childNode,
...
var Popup = /*#__PURE__*/ React.forwardRef(function (_ref, ref) {
  ...
  var cloneProps = _objectSpread__default['default'](
    _objectSpread__default['default']({}, props),
    {},
    {
  ...
  var popupNode = inMobile
    ? /*#__PURE__*/ React.createElement(
        MobilePopupInner,
        _extends__default['default']({}, cloneProps, {
          mobile: mobile,
          ref: ref,
        }),
      )
...
function generateTrigger(PortalComponent) {
  var Trigger = /*#__PURE__*/ (function (_React$Component) {
    _inherits__default['default'](Trigger, _React$Component);

    var _super = _createSuper__default['default'](Trigger);

    function Trigger(props) {
      var _this;

      _classCallCheck__default['default'](this, Trigger);
      ...
      _this.getRootDomNode = function () {
        ...
        return ReactDOM__default['default'].findDOMNode(
      ...
      [
        ...
        },
        {
          ...
          value: function render() {
            ...
            var childrenClassName = classNames__default['default'](
...
function isIconDefinition(target) {
  return (
    _typeof__default['default'](target) === 'object' &&
    typeof target.name === 'string' &&
    typeof target.theme === 'string' &&
    (_typeof__default['default'](target.icon) === 'object' ||
...
function getTwoToneColors() {
  return _objectSpread__default['default']({}, twoToneColorPalette);
}
...
var IconBase = function IconBase(props) {
  var icon = props.icon,
    ...
    restProps = _objectWithoutProperties__default['default'](
      props,
      _excluded$2,
    );
  ...
  if (target && typeof target.icon === 'function') {
    target = _objectSpread__default['default'](
      _objectSpread__default['default']({}, target),
      {},
      {
...
function setTwoToneColor(twoToneColor) {
  var _normalizeTwoToneColo = normalizeTwoToneColors(twoToneColor),
    _normalizeTwoToneColo2 = _slicedToArray__default['default'](
...
var PopFunction = function PopFunction(props) {
  ...
  var disabledHoursList = React.useMemo(
    function () {
      if (!isvisible) {
        return [];
      }
  ...
  var disabledMinutesList = React.useMemo(
    function () {
      if (!isvisible) {
        return [];
      }
          ...
          /*#__PURE__*/ React__default['default'].createElement(
            antd.Button,
            {
              ...
              onClick: function onClick() {
                ...
                var localTimeString =
                  moment__default['default']().format('HH:mm') === '00:00'
                    ? '24:00'
                    : moment__default['default']().format('HH:mm');
...
var TimePicker = function TimePicker(props) {
  ...
  var AssignmentData = function AssignmentData(accValue) {
    ...
    if (accValue !== null) {
      ...
      setHourValue(
        (_moment = moment__default['default'](accValue, format)) === null ||
          _moment === void 0
          ? void 0
          : _moment.format('HH'),
      );
      setMinuteValue(
        (_moment2 = moment__default['default'](accValue, format)) === null ||
          _moment2 === void 0
          ? void 0
          : _moment2.format('mm'),
      );
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    /*#__PURE__*/ React__default['default'].createElement(
      ...
      _objectSpread2(
        {
          action: ['click'],
          popup: /*#__PURE__*/ React__default['default'].createElement(
            PopFunction,
            _objectSpread2(
